...
| contingency                                      | непредвиденные обстоятельства, случайность                                                                                   |
| contradict                                       | смягчать                                                                                                                     |
...
| hijacker/victim                                  | угонщик(налетчик)/жертва                                                                                                     |
| hoax                                             | обман                                                                                                                        |
| holistic                                         | целостный                                                                                                                    |
| honed                                            | отточенный                                                                                                                   |
...
| preemptible                                      | прерываться, превентивный                                                                                                    |
...
| rumor                                            | слух                                                                                                                         |
| run down                                         | изнуряться, переутомляться                                                                                                   |
...
| state pension                                    | гос. пенсия                                                                                                                  |
| state-of-the-art                                 | продвинутый, ультра-модный                                                                                                   |
| stay in                                          | быть дома                                                                                                                    |
| steadily                                         | неуклонно, постоянно                                                                                                         |
| steady                                           | устойчивый, неуклонный, постоянный                                                                                           |
| steep                                            | крутой (подъем)                                                                                                              |
| stemming from                                    | вытекает из                                                                                                                  |
| step-by-step                                     | do smth gradually                                                                                                            |
| stiff                                            | жесткий                                                                                                                      |
| still                                            | все еще                                                                                                                      |
| stipulate                                        | оговаривать, ставить условием                                                                                                |
| stitching                                        | сшивание                                                                                                                     |
| strain                                           | напряжение                                                                                                                   |
| strap                                            | ремень, завязка                                                                                                              |
| stray                                            | бродяга(n) / заблудиться, бездомный (v)                                                                                      |
| strike (to go on a strike)                       | забастовка                                                                                                                   |
| stringent (condition, requirement)               | строгий, обязательный                                                                                                        |
| strive for smth                                  | стремиться к чему-то                                                                                                         |
| stubborn                                         | упертый                                                                                                                      |
| stuffy                                           | душный                                                                                                                       |
| stutter                                          | заикание                                                                                                                     |
| suave                                            | учтивый                                                                                                                      |
| sub-standard                                     | некондиционный                                                                                                               |
| subdue                                           | подчинять                                                                                                                    |
| subdued                                          | покоренный, приглушенный/смягченный                                                                                          |
...
| successor                                        | преемник                                                                                                                     |
| succinctly                                       | сжато, кратко, лаконично                                                                                                     |
| suffer                                           | страдать                                                                                                                     |
| suffice                                          | достаточно, хватит                                                                                                           |
| sufficiently                                     | достаточно                                                                                                                   |
| suing                                            | возбуждать дело                                                                                                              |
| suitable                                         | подходящий                                                                                                                   |
| suite                                            | набор, апартаменты                                                                                                           |
| sunscreen                                        | солнцезащитный крем                                                                                                          |
| superficially                                    | поверхностно, поверхностный                                                                                                  |
| superfluous                                      | лишнее, лишний                                                                                                               |
| superior                                         | превосходящие другого, начальник                                                                                             |
...
| supportive                                       | behaving in an offensive way, not polite                                                                                     |
| suppose                                          | думать, предполагать                                                                                                         |
| suppress                                         | подавлять                                                                                                                    |
| surpass                                          | превосходить                                                                                                                 |
| surreptitiously                                  | исподтишка                                                                                                                   |
...
| tactful                                          | тактичный, careful not to say or do anything that could upset or offend someone                                              |
| tailor                                           | специально приспосабливать, портной, шить                                                                                    |
...
| tampering                                        | подделывать, вмешиваться                                                                                                     |
| tangible                                         | ощутимый, осязаемый, материальный                                                                                            |
...
| tense                                            | напряженный                                                                                                                  |
| tentative                                        | предварительный, пробный, экспериментальный                                                                                  |
...
| theft                                            | кража                                                                                                                        |
| themselves                                       | сами, самих себя                                                                                                             |
| then                                             | затем                                                                                                                        |
| thereafter                                       | после этого                                                                                                                  |
| thereby                                          | тем самым                                                                                                                    |
| therefore                                        | следовательно                                                                                                                |
| thereof                                          | этого, из этого                                                                                                              |
| these                                            | эти                                                                                                                          |
| thorny                                           | тернистый, колючий                                                                                                           |
| thorough                                         | тщательный, полный, подробный                                                                                                |
| thoroughly                                       | тщательно                                                                                                                    |
| though                                           | хотя, несмотря на                                                                                                            |
| thought                                          | думал, мысль, мнение                                                                                                         |
| thoughtfully                                     | глубокомысленно                                                                                                              |
| threat                                           | угроза                                                                                                                       |
| threatening                                      | угрожающий                                                                                                                   |
| thrill                                           | трепет                                                                                                                       |
| thrive                                           | процветать                                                                                                                   |
| throughout                                       | на всем протяжении, по всему                                                                                                 |
| throughput                                       | пропускная способность                                                                                                       |
| thrust                                           | толчок, удар, выпад                                                                                                          |
| tidy                                             | аккуратный, чистый                                                                                                           |
| tidy up                                          | убирать, приводить в порядок                                                                                                 |
| tight                                            | плотно                                                                                                                       |
| tight connection                                 | тесная связь                                                                                                                 |
| tight schedules                                  | сжатые сроки                                                                                                                 |
| till                                             | касса                                                                                                                        |
| timely                                           | своевременно                                                                                                                 |
| timid/shy/modest                                 | робкий, застенчивый                                                                                                          |
...
| to assume                                        | to accept smth to be true without question or proof                                                                          |
| to be a must                                     | обязательно                                                                                                                  |
| to be a sign of                                  | быть признаком                                                                                                               |
| to be a solid communicator                       | be very good at delivering a speech                                                                                          |
| to be a source of anxiety                        | быть источником беспокойства                                                                                                 |
| to be a stepping stone                           | быть переходным этапом                                                                                                       |
| to be addicted to smth                           | быть зависимым от чего-то                                                                                                    |
| to be an asset                                   | быть активом/быть важным для компании                                                                                        |
| to be attentive to detail                        | внимательный к деталям                                                                                                       |
| to be content                                    | быть довольным                                                                                                               |
| to be content with                               | довольствоваться, to be happy and satisfied                                                                                  |
| to be dead set to do smth                        | to be determined to do smth                                                                                                  |
| to be engaged                                    | быть вовлеченным                                                                                                             |
| to be homesick                                   | тосковать по родине                                                                                                          |
| to be honest                                     | если честно                                                                                                                  |
| to be marked as a concern                        | отмечен, как проблема                                                                                                        |
| to be on a business trip                         | быть в командировке                                                                                                          |
| to be on a high-fliers list                      | быть одним из высокопроизводительных сотрудников                                                                             |
| to be prohibited                                 | запрещается                                                                                                                  |
| to be scared                                     | бояться                                                                                                                      |
| to be time-consuming                             | быть трудоемким                                                                                                              |
| to be tiring                                     | быть утомительным                                                                                                            |
| to be willing                                    | хотеть, желать                                                                                                               |
...
| to commute                                       | смягчать, добираться                                                                                                         |
...
| to elongate                                      | продлить                                                                                                                     |
| to embarrass                                     | смущать, стеснять, конфузить                                                                                                 |
| to embellish                                     | приукрашивать                                                                                                                |
| to enroll on                                     | записаться на                                                                                                                |
| to ensure                                        | to make smth certain to happen                                                                                               |
...
| to highlight                                     | выделить, придать большое значение                                                                                           |
| to lean                                          | опираться                                                                                                                    |
| to make an appointment                           | назначить встречу                                                                                                            |
| to make time                                     | торопиться                                                                                                                   |
...
| to rely on smth/smb                              | сослаться на что-то/кого-то                                                                                                  |
...
| to tolerate                                      | терпеть, допускать, позволять                                                                                                |
...
| travel/journey/trip                              | путешествие/длинная/короткая поездка                                                                                         |
| traversal                                        | обход                                                                                                                        |
| traversed                                        | пересекать, перемещаться                                                                                                     |
| traversing                                       | обход, перемещение/пересечение                                                                                               |
| treacherous                                      | вероломный                                                                                                                   |
| treat (v)                                        | относиться                                                                                                                   |
| trek/hike                                        | путешествие                                                                                                                  |
| tremendous                                       | потрясающий, чрезвычайный, огромный                                                                                          |
| trial                                            | разбирательство (судебное)                                                                                                   |
| trifle                                           | мелочь, пустяк                                                                                                               |
| trolley                                          | багажная вагонетка                                                                                                           |
| trough                                           | впадина                                                                                                                      |
| trumpet                                          | труба                                                                                                                        |
| tuple                                            | кортеж                                                                                                                       |
| turnover                                         | оборот                                                                                                                       |
| turns out                                        | оказывается                                                                                                                  |
| twists                                           | повороты, кручение                                                                                                           |
| tying                                            | завязывание                                                                                                                  |
| typhoon                                          | тайфун                                                                                                                       |
...
| unsociable                                       | нелюдимый                                                                                                                    |
| unsolicited                                      | непрошенный                                                                                                                  |
| unveil                                           | открывать                                                                                                                    |
| unviable                                         | нежизнеспособный                                                                                                             |
| unwieldy                                         | громоздкий                                                                                                                   |
| unwitting                                        | невольный                                                                                                                    |
| up a notch                                       | на ступень выше                                                                                                              |
| up-to-par                                        | в нормальном состоянии                                                                                                       |
| upheveal                                         | переворот                                                                                                                    |
| upshot                                           | результат, развязка                                                                                                          |
| urge                                             | побуждать                                                                                                                    |
| usher in                                         | возвещать                                                                                                                    |
| ushered                                          | возвещать, объявлять                                                                                                         |
| utterly                                          | вконец, крайне, абсолютно                                                                                                    |
...
| verbatim                                         | дословный                                                                                                                    |
| verbose                                          | подробный, многословный                                                                                                      |
...
| wary                                             | осторожный                                                                                                                   |
| was prompt                                       | была быстрой                                                                                                                 |
| wealthy                                          | состоятельный                                                                                                                |
| weigh up alternatives                            | options                                                                                                                      |
| well maintained                                  | в хорошем состоянии                                                                                                          |
| wet bar                                          | бар с краном воды                                                                                                            |
| whatever                                         | неважно, какой бы ни, без разницы, любой                                                                                     |
...
| whim                                             | прихоть, каприз                                                                                                              |
| whine and moan                                   | ныть и стонать                                                                                                               |
| whisk                                            | юркнуть, смахнуть, быстро уносить, сгонять                                                                                   |
| whiskers                                         | бакенбарды                                                                                                                   |
| whistle                                          | свисток                                                                                                                      |
| wholeheartedly                                   | искренне                                                                                                                     |
| wig                                              | парик                                                                                                                        |
| willingness                                      | готовность                                                                                                                   |
| withdrew                                         | изымать, отозвать                                                                                                            |
| within                                           | в, в пределах                                                                                                                |
...
| wounded                                          | ранен                                                                                                                        |
| wraith                                           | призрак                                                                                                                      |
| wrangle                                          | спорить, пререкаться, пасти стадо                                                                                            |
| wrestle                                          | упорная борьба                                                                                                               |
| wrinkle                                          | морщина, складка                                                                                                             |
| wrist                                            | запястье                                                                                                                     |
| yell                                             | вопить, кричать                                                                                                              |
| yield                                            | уступать, давать, приносить, доходность                                                                                      |
